...
const jsPath = path.join(dist, 'drug-intelligence.js');
if (!fs.existsSync(indexPath)) throw new Error('app/dist/index.html not found');
...
if (!html.includes('/drug-intelligence.js')) html = html.replace('</body>', '<script defer src="/drug-intelligence.js"></script></body>');
fs.writeFileSync(indexPath, html, 'utf8');
console.log('Drug Intelligence UI injected');
